...
def main():
    ...
    webscraper = WebScraper('https://arriendayvende.com/busqueda-avanzada/?keyword=&states%5B%5D=&location%5B%5D=&bedrooms=&bathrooms=&min-area=&max-area=&property_id=&min-price=&max-price=',45,50)
